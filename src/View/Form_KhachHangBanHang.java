...
public class Form_KhachHangBanHang extends javax.swing.JFrame {
    ...
    public static HoaDonChoRepository hoaDonChoRepository = new HoaDonChoRepository();
    ...
    public Form_KhachHangBanHang(Form_BanHang banHangfr, JTable tb_hoadon) {
        initComponents();
    ...
    private void btn_chonmuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_chonmuaActionPerformed
        ...
        if (row < 0) {
            ...
            if (rowHD < 0) {
                ...
                String idHD = hoaDonChoRepository.getIdHoaDonByMa(tb_hoadon.getValueAt(rowHD, 0).toString());
                ...
                tb_hoadon.setRowSelectionInterval(banHangfr.selectedRowInBanHang, banHangfr.selectedRowInBanHang);
